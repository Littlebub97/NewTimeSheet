#pragma checksum "C:\Users\littlebub97\source\repos\NewTimeSheet2\NewTimeSheet2\Views\Home\Manager.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2421cbd8d3dcbff1086b94c79d2daa22a5377cfe"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2421cbd8d3dcbff1086b94c79d2daa22a5377cfe", @"/Views/Home/Manager.cshtml")]
...
#line hidden
            EndContext();
            BeginContext(67, 1939, true);
            WriteLiteral(@"</h1>
<% if(this.User.Identity.IsAuthenticated) { %>
<% } %>
<authorization>
    <allow users=""mario@smashbros.nintendo"" />
    <deny users=""kirby@smashbros.nintendo"" />
</authorization>
...
<table border=""5"" width=""100%"" cellpadding=""4"" cellspacing=""3"">
    ...
    <tr align=""center"">
        <td>Luigi</td>
        <td>2</td>
        <td>12/4/2018 12:00 pm</td>
        <td>Manager <input id=""Checkbox1"" type=""checkbox"" /></td>
    </tr>
    <tr align=""center"">
        <td>Bowser</td>
        <td>3</td>
        <td>12/4/2018 1:30 pm</td>
        <td>HR <input id=""Checkbox1"" type=""checkbox"" /></td>

    </tr>

</table>
<button type=""button"" value=""Refresh Page"" onclick=""window.location.reload()"">Submit</button>
<script>
